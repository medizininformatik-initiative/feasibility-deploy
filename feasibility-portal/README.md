...
| FEASIBILITY_BACKEND_PRIVACY_QUOTA_HARD_CREATE_INTERVAL                            | Set how much time within which user can send hard create amount - if exceeded user will be blacklisted (ISO 8601 duration)                                                   | PT7D                                                                                             | Duration        | BACKEND   |
